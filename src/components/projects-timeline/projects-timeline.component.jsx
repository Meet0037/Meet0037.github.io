          ...
          >
            <div className="d-flex justify-content-between flex-column mt-2">
                ...
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> Detect Mask from human faces whether they have weared Mask or not in this pandemic situation.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>Detect mask from human faces with great accuracy</li>
                          <li>Give signal to an image by which easy to see</li>
                          <li>Detect COVID-19 face masks in video stream</li>
                        </ul>
                        <hr />
              ...
              <div>
                ...
                <UrlButton
                  className="urlbutton"
                  href="https://github.com/Meet0037/FaceMaskDetection-COVID19"
                  target="_blank"
                >
                  Source Code
                </UrlButton>
              ...
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> All the python mini projects like,
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>COVID19 cases world map using python</li>
                          <li>Barcode detection using python, OpenCV</li>
                          <li>Music player using python</li>
                          <li>Convert image into sketch using python</li>
                          <li>Whatsapp automation using python</li>
                          &amp; more...
                        </ul>
                        <hr />
                        <strong>Tech used:</strong>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-2">
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> Simple Blog using Front web with HTML, CSS and Bootstrap. 
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  className="urlbutton"
                  href="https://github.com/Meet0037/SimpleDummyBlog"
                  target="_blank"
                >
                  Source Code
                </UrlButton>
                ...
                <UrlButton
                  className="urlbutton"
                  href="https://meet0037.github.io/SimpleDummyBlog/"
                  target="_blank"
                >
                  See Live
                </UrlButton>
